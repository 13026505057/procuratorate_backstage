        ...
        data()  {
            return  {
                ...
                addSearch: [
                    ...
                    { dom: 'case_name', value: '',placeholder: '请输入案件名称', itemId: 4, name: 'input' },
                    { dom: 'begin_time', value: '',placeholder: '操作开始时间', itemId: 5, name: 'daterange_begin' },
                    { dom: 'end_time', value: '',placeholder: '操作结束时间', itemId: 6, name: 'daterange_end' },
                    { dom: 'nd', value: '',placeholder: '年度', itemId: 7, name: 'dataPicker' },
                    { dom: 'bgr', value: '',placeholder: '嫌疑人', itemId: 8, name: 'input' },
